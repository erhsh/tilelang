...
Usage::
    ...
    TILELANG_PASS_TRACE=1 python my_kernel.py        # HTML report
    TILELANG_PASS_TRACE=terminal python my_kernel.py  # terminal diff only
    TILELANG_PASS_TRACE=both python my_kernel.py      # both terminal and HTML

Programmatic API::

    from tilelang.tools.pass_trace import pass_diff

    pass_diff(func, my_pass, mode="terminal")
    pass_diff(func, [pass_a, pass_b], mode="both", html_path="diff.html")
"""

from __future__ import annotations

from .core import patch, reset, PassRecord, STATUS_COMPLETED, STATUS_FAILED, STATUS_SKIPPED
