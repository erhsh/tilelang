...
def unified_diff(
    ...
    Args:
        ...
        before_label: Label for the before file in the diff header
        after_label:  Label for the after file in the diff header
        context:      Number of context lines around changes
        color:        If True, apply ANSI color codes for terminal display

    Returns:
        Unified diff string (empty string if texts are identical)
    """
